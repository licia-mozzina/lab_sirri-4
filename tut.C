...
void rf706_histpdf() {
  ...
  RooDataSet* data1 = RooDataSet::read("_cms_higgs_TTbarto4l.txt", RooArgList(x, weight), "v");
  ...
  // Plot unbinned data and histogram pdf overlaid
  RooPlot *frame2 =
      x.frame(Title("High stats histogram pdf with interpolation"), Bins(100));
  data2->plotOn(frame2);
